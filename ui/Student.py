...
# Form implementation generated from reading ui file 'ui/ui_template/student.ui'
#
...
class Window_student(QtWidgets.QMainWindow, student_ui):
    ...
    def save(self):
        ...
        if self.flag:
            self.bd.update_student_info(groups, name, Phone_number, Snils, Pers_data, School, Class, Email, Comment, vk_id, Telegram_id, discord_id, id=self.id)
            QtWidgets.QMessageBox.about(self, "Успешно", "Данные человека изменены 1")
        else:
            self.bd.add_student(groups, name, Phone_number, Snils, Pers_data, School, Class, Email, Comment, vk_id, Telegram_id, discord_id)
